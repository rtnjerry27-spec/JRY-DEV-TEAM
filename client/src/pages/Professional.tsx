...
export function PluginsPage() {
  ...
  return <AppShell><PageIntro eyebrow="PLUGIN DISCOVERY" title="Plugin Explorer" description="Search Modrinth projects in a focused, server-admin workflow. CurseForge stays one click away for its broader catalog."><AccentTag color="aqua"><Globe2 className="mr-1 size-3" /> Modrinth live search</AccentTag></PageIntro>
